Spree::AppConfiguration.class_eval do
  ...
  preference :store_twitter_uri, :string, :default => 'twitter_uri'
  preference :store_facebook_uri, :string, :default => 'facebook_uri'
  preference :store_pinterest_uri, :string, :default => 'pinterest_uri'
  preference :store_youtube_uri, :string, :default => 'youtube_uri'
  preference :store_google_plus_uri, :string, :default => 'google_plus_uri'
  preference :store_linkedin_uri, :string, :default => 'linkedin_uri'
